...
You can read more about the default scenarios in the [documentation](https://vizdoom.farama.org/environments/default/). Some of these files are also used in the [examples](https://github.com/Farama-Foundation/ViZDoom/tree/main/examples/python).
